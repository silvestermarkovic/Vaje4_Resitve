...
namespace Naloga2
{
...

    {
        ...
        //TODO: 2.2. ustvarite privatni seznam _strezniki tipa Strezniki (get/set)
        ...
        //TODO: 2.3. Naredite konstruktor, ki bo napolnil _strezniki s podatki o 3-5 streznikih
        ...
        public Streznik NaslednjiStreznik(int pteza)
        {
            ...
            //TODO: 2.4. spremenite tako, da bo obremenilo, najmanj obremenjeni strežnik
            while (true)
            { 
                ...
                var najmanjssi =  from s in _strezniki
                                      where (s.ObremenitevMax - s.Obremenitev ) > pteza
